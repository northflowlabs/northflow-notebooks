...
Open, reproducible science notebooks across climate, space, and Earth observation.

Built by [Northflow Technologies](https://northflow.no) — AI-native infrastructure for science.
...
[![climval](https://img.shields.io/pypi/v/climval?label=climval)](https://pypi.org/project/climval)
[![PyPI](https://img.shields.io/badge/pip%20install-climval-blue)](https://pypi.org/project/climval)
